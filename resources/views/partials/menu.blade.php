                ...
                @can('oruzja_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.oruzjas.index") }}" class="nav-link {{ request()->is("admin/oruzjas") || request()->is("admin/oruzjas/*") ? "active" : "" }}">
                            ...
                            <p>
                                {{ trans('cruds.oruzja.title') }}
                            </p>
                        </a>
                    </li>
                @endcan
                @can('tipvojske_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.tipvojskes.index") }}" class="nav-link {{ request()->is("admin/tipvojskes") || request()->is("admin/tipvojskes/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-cogs">
