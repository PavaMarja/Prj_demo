                ...
                <tbody>
                    <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-entry-id="<?php echo e($currency->id); ?>">
                            ...
                            <td>
                                <span style="display:none"><?php echo e($currency->main_currency ?? ''); ?></span>
                                <input type="checkbox" disabled="disabled" <?php echo e($currency->main_currency ? 'checked' : ''); ?>>
                            </td>
                            <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pmarjano/public_html/osobniportal/resources/views/admin/currencies/index.blade.php ENDPATH**/ ?>