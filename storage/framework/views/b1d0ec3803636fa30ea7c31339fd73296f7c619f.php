            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-ExpenseCategory">
                ...
                <tbody>
                    <?php $__currentLoopData = $expenseCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $expenseCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-entry-id="<?php echo e($expenseCategory->id); ?>">
                            <td>

                            </td>
                            <td>
                                <?php echo e($expenseCategory->id ?? ''); ?>
                            ...
                            <td>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('expense_category_show')): ?>
                                    <a class="btn btn-xs btn-primary" href="<?php echo e(route('admin.expense-categories.show', $expenseCategory->id)); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('expense_category_edit')): ?>
                                    <a class="btn btn-xs btn-info" href="<?php echo e(route('admin.expense-categories.edit', $expenseCategory->id)); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('expense_category_delete')): ?>
                                    <form action="<?php echo e(route('admin.expense-categories.destroy', $expenseCategory->id)); ?>" method="POST" onsubmit="return confirm('<?php echo e(trans('global.areYouSure')); ?>');" style="display: inline-block;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pmarjano/osobniportal/resources/views/admin/expenseCategories/index.blade.php ENDPATH**/ ?>