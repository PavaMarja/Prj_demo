...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('crm_customer_create')): ?>
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="<?php echo e(route('admin.crm-customers.create')); ?>">
                <?php echo e(trans('global.add')); ?> <?php echo e(trans('cruds.crmCustomer.title_singular')); ?>
...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('cruds.crmCustomer.title_singular')); ?> <?php echo e(trans('global.list')); ?>
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-CrmCustomer">
                ...
                <tbody>
                    <?php $__currentLoopData = $crmCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $crmCustomer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-entry-id="<?php echo e($crmCustomer->id); ?>">
                            <td>
                            ...
                            <td>
                                <?php echo e($crmCustomer->status->name ?? ''); ?>
                            ...
                            <td>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('crm_customer_show')): ?>
                                    <a class="btn btn-xs btn-primary" href="<?php echo e(route('admin.crm-customers.show', $crmCustomer->id)); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('crm_customer_edit')): ?>
                                    <a class="btn btn-xs btn-info" href="<?php echo e(route('admin.crm-customers.edit', $crmCustomer->id)); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('crm_customer_delete')): ?>
                                    <form action="<?php echo e(route('admin.crm-customers.destroy', $crmCustomer->id)); ?>" method="POST" onsubmit="return confirm('<?php echo e(trans('global.areYouSure')); ?>');" style="display: inline-block;">
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('crm_customer_delete')): ?>
  ...
  let deleteButton = {
    ...
    url: "<?php echo e(route('admin.crm-customers.massDestroy')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pmarjano/osobniportal/resources/views/admin/crmCustomers/index.blade.php ENDPATH**/ ?>